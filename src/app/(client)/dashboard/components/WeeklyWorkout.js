...
import { Dumbbell, Check, CheckSquare, Square, Loader2, Moon, Flame } from 'lucide-react'; 
    ...
    async function fetchWeeklySchedule() { 
      try { 
        ...
        if (res.ok) { 
          ...
          // Backend'den gelen estimated_calories değerini
          // her günün schedule verisine normalize et.
          const normalizedSchedule = Object.entries(rawSchedule).reduce(
            (acc, [day, dayData]) => {
              ...
              acc[day] = {
                ...
                exercises: Array.isArray(safeDayData.exercises)
        ...
        {loading ? ( 
          ...
          <> 
            ...
            <div className="mb-3 flex items-center justify-between gap-3"> 
              ...
              {estimatedCalories > 0 && (
                <div 
                  className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-orange-500/10 border border-orange-500/30 shadow-[0_0_12px_rgba(249,115,22,0.18)]"
                ...
                >
                  ...
                  />
                  <span className="text-[11px] font-black text-orange-300 whitespace-nowrap">
