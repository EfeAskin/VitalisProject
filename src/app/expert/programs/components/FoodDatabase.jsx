            ...
            >
              ...
              <div>
                <div className="flex justify-between items-start mb-4">
                  <span className="text-[10px] font-black tracking-wider uppercase px-3 py-1.5 rounded-xl border bg-slate-800/80 text-slate-300 border-slate-700/60">
                    {food.unit}
                  </span>
                  <button
          ...
          <div className="bg-[#11142D] border border-slate-700/80 w-full max-w-lg rounded-3xl p-6 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 backdrop-blur-md">
            ...
            <form onSubmit={handleCreateFood} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-300 mb-1.5">Porsiyon / Ölçü Birimi</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full px-4 py-2.5 bg-[#11142D] text-xs font-semibold text-white placeholder-slate-400 rounded-xl border border-slate-700/60 focus:outline-none focus:border-[#EA580C] transition-all"
                  />
                </div>
              </div>
