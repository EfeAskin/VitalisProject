    ...
    return (
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-12 text-center space-y-4">
        ...
        <p className="text-xs text-slate-400">
          Danışanlar paket satın aldıklarında veya abone olduklarında başvurular buraya düşecektir.
        </p>
      </div>
    );
  }
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {requests.map((req) => {
        ...
        return (
          <div
            key={reqId}
            className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-5 shadow-xl relative flex flex-col justify-between"
          >
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-xs text-slate-400 px-1 gap-2">
